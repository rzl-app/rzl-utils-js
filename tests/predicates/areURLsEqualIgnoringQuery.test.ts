...
import { areURLsEqualIgnoringQuery } from "@/predicates";

describe("areURLsEqualIgnoringQuery", () => {
  it("should return true for identical URLs with identical query", () => {
    ...
    expect(areURLsEqualIgnoringQuery(url1, url2)).toBe(true);
  });
  ...
  it("should return false for different protocols", () => {
    ...
    expect(areURLsEqualIgnoringQuery(url1, url2)).toBe(false);
  });
