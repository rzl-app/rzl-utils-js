 ...
 * ---------------------------------
 *
 * Enhances autocomplete and type inspection clarity in IDEs.
 *
 ...
 *
 * @example
 * const config: Obj_Array_keyString_any = {
 *   mode: "dark",
 *   retries: 3,
 *   debug: true,
 * };
 */
export type Obj_Array_keyString_any = {
  [key: string]: any;
};
 ...
 *
 * @example
 * type T = ReplaceAll<"foo-bar-bar", "bar", "baz">; // "foo-baz-baz"
 */
